...
void DLSSFeature::ProcessInitParams(NVSDK_NGX_Parameter* InParameters)
{
    ...
    else
    {
        ...
        {
            // Driver model overrides remain with the driver. Its policy value
            // (including Latest/Recommended) is not a per-quality NGX preset.
            // Preserve game requests here; local 033 overrides use the branch above.
