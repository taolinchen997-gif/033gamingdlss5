...
bool IFeature_VkwDx12::Evaluate(VkCommandBuffer InCmdBuffer, NVSDK_NGX_Parameter* InParameters)
{
    ...
    do
    {
        ...
        if (dx12EvalResult)
            {
                k033core::Metadata metadata{1,static_cast<uint32_t>(GetFeatureFlags()),1,TargetWidth(),TargetHeight()};
                k033core::Scope scope(metadata,reinterpret_cast<uintptr_t>(this),k033core::VulkanBridge);
                k033core::context.completed=true;
