...
class StreamlineHooks
{
  ...
  private:
    ...
    inline static decltype(&sl1::slIsFeatureSupported) o_slIsFeatureSupported_sl1 = nullptr;
    inline static decltype(&sl1::slIsFeatureEnabled) o_slIsFeatureEnabled_sl1 = nullptr;
    inline static decltype(&sl1::slSetFeatureEnabled) o_slSetFeatureEnabled_sl1 = nullptr;
    ...
    static bool hkslIsFeatureSupported_sl1(sl1::Feature feature, uint32_t* adapterBitMask);
    static bool hkslIsFeatureEnabled_sl1(sl1::Feature feature);
    static bool hkslSetFeatureEnabled_sl1(sl1::Feature feature, bool enabled);
    ...
    VALIDATE_MEMBER_HOOK(hkslIsFeatureSupported_sl1, decltype(&sl1::slIsFeatureSupported))
    VALIDATE_MEMBER_HOOK(hkslIsFeatureEnabled_sl1, decltype(&sl1::slIsFeatureEnabled))
    VALIDATE_MEMBER_HOOK(hkslSetFeatureEnabled_sl1, decltype(&sl1::slSetFeatureEnabled))
