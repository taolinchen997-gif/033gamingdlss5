...
#if K033_BETA2_RESHADE_HOST
    addon_all_loaded = k033_register_renderer();
    return;
#endif
...
{
#if K033_BETA2_RESHADE_HOST
    if (!k033_is_core_module(module))
        return false; // Product owns one reviewed renderer, no external scan.
#endif
